...
var questions = [{
    ...
    answerList: ["Both head and body section", "The head section","The body section","None"],
    answer: 0
},{
    question: "How do you write Hello World in an alert box?",
    answerList: ["alert(Hello World)","msgBox(Hello World)","alertBox=Hello World","alertBox (Hello World)" ],
    answer: 0
},{
    question: "Inside which HTML element do we put the JavaScript?",
    answerList: ["javascript", "js", "scripting", "script"],
    answer: 3
},{
    question: "How do you create a function?",
    answerList: ["function:myFunction()", "function=myFunction()", "function myFunction()", "myFunction():function"],
    answer: 2
},{
    question: "How do you call a function named myFunction?",
    answerList: ["call myFunction", "myFunction()", "call function myFunction", "Call.myFunction()"],
    answer: 1
},{
    question: "What is the correct JavaScript syntax to write Hello World?",
    answerList: ["response.write Hello World", "Hello World", "document.write(Hello World)", "(Hello World)"],
    answer: 2
},{
    question: "How to write an IF statement in JavaScript",
    answerList: ["if i==5", "if(i==5) then", "if i=5 then", "if i=5"],
    answer: 0,
}];
